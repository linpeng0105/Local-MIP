...
result="/pub/netdisk1/linpeng/Local-MIP/result/Local-MIP/v2/turn/20/log/"

sampleUnsat="3 6"
bmsUnsatInfeas="500 1200 2000"
bmsUnsatFeas="50 100 200"
sampleSat="5 10 20"
bmsSat="50 90 150"
bmsRandom="25 50 100"
restartStep="1000000 3000000 5000000"
...
for f in $bmsRandom
do
for g in $restartStep
do
  for((i=0;i<${#all_datas[*]};i++))
  do
    instance=${all_datas[$i]}
    res_solver_ins=$result/${a}_${b}_${c}_${d}_${e}_${f}_${g}
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP -i $instance/$file --cutoff=60 --sampleUnsat=$a --bmsUnsatInfeas=$b --bmsUnsatFeas=$c --sampleSat=$d --bmsSat=$e --bmsRandom=$f --restartStep=$g
        echo >&6
