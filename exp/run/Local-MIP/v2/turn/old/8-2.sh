...
result="/pub/netdisk1/linpeng/Local-MIP/result/Local-MIP/v2/turn/8/log/"
ulimit -t 400
sampleUnsat="8"
bmsUnsat="1000 1500 2000 2500 3000 3500 4000 4500 5000 5500 6000 6500 7000 7500 8000 8500 9000 9500"
sampleSat="35"
bmsSat="125"
bmsRandom="50"
restartStep="1500000"
  ...
  do
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP -i $instance/$file --cutoff=300 --sampleUnsat=${a} --bmsUnsat=${b} --sampleSat=${c} --bmsSat=${d} --bmsRandom=${e} --restartStep=${f} --wf=${g} 
        echo >&6
