...
result="/pub/netdisk1/linpeng/Local-MIP/result/Local-MIP/v2/turn/6/log/"
ulimit -t 400
sampleUnsat="8"
bmsUnsat="4000"
sampleSat="30 35 40 45 50"
bmsSat="25 50 75 100 125 150"
bmsRandom="50 150"
restartStep="500000 1500000"
wf="10"
  ...
  do
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP -i $instance/$file --cutoff=300 --sampleUnsat=${a} --bmsUnsat=${b} --sampleSat=${c} --bmsSat=${d} --bmsRandom=${e} --restartStep=${f} --wf=${h} 
        echo >&6
