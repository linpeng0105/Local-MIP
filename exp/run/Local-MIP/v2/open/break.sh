...
benchmark_list="/pub/netdisk1/linpeng/Local-MIP/benchmark/list/break.txt"
result="/pub/netdisk1/linpeng/Local-MIP/result/Local-MIP/v2/break/"
sampleUnsat="8"
bmsUnsatInfeas="1700"
bmsUnsatFeas="100"
sampleSat="50"
  ...
  do
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP -i $instance/$file --cutoff=3600 --PrintSol=1 --sampleUnsat=${a} --bmsUnsatInfeas=${b} --bmsUnsatFeas=${c} --sampleSat=${d} --bmsSat=${e}
        echo >&6
