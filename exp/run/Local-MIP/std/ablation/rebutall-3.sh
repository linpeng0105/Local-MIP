...
result="/pub/netdisk1/linpeng/Local-MIP/result-new/Local-MIP/v6/rebuttal/wf/"
WF="4 5 6 7 8 9 10"
for wf in $WF
do
    ...
    do
        ...
        do
            ...
            read -u 6
            {
                cd /pub/netdisk1/linpeng/Local-MIP/code/bin/rebuttal/
                time ./Local-MIP-rebuttal -i $instance/$file --wf=$wf --cutoff=300
                echo >&6
