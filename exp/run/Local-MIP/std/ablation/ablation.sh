...
result="/pub/netdisk1/linpeng/Local-MIP/result-new/Local-MIP/v6/ablation/no-bonus"
for co in $cutoff
do
  ...
  do
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP-no-bonus -i $instance/$file --cutoff=$co
        echo >&6
...
result="/pub/netdisk1/linpeng/Local-MIP/result-new/Local-MIP/v6/ablation/no-om"
for co in $cutoff
do
  for((i=0;i<${#all_datas[*]};i++))
  do
...
result="/pub/netdisk1/linpeng/Local-MIP/result-new/Local-MIP/v6/ablation/no-weight"
for co in $cutoff
do
  for((i=0;i<${#all_datas[*]};i++))
  do
    ...
    do
      ...
      {
        cd /pub/netdisk1/linpeng/Local-MIP/code/bin/ablation
        time ./Local-MIP-no-weight -i $instance/$file --cutoff=$co
        echo >&6
      } >$res_solver_ins/$file   2>>$res_solver_ins/$file &
    done
  done
