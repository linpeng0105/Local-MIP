...
result="/pub/netdisk1/linpeng/Local-MIP/result-new/Local-MIP/v5/open/"
...
do
  ...
  do
    ...
    res_solver_ins=$result/_${a}_${b}_${c}_${d}_${e}_${f}_${g}_${h}_123/${co}
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP -i $instance/$file --cutoff=172800 --sampleUnsat=$a --bmsUnsatInfeas=$b --bmsUnsatFeas=$c --sampleSat=$d --bmsSat=$e --bmsFlip=$f --bmsRandom=$g --sp=$h --Seed=123
        echo >&6
