...
result="/pub/netdisk1/linpeng/Local-MIP/result/Local-MIP/v3/open/"
sampleUnsat="9"
bmsUnsatInfeas="1500"
bmsUnsatFeas="125"
sampleSat="15"
  ...
  do
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP -i $instance/$file --cutoff=86400 --PrintSol=1 --sampleUnsat=$a --bmsUnsatInfeas=$b --bmsUnsatFeas=$c --sampleSat=$d --bmsSat=$e --bmsFlip=$f --bmsRandom=$g --wf=$h
        echo >&6
