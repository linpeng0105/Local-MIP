...
result="/pub/netdisk1/linpeng/Local-MIP/result/Local-MIP/v4/open/"
  ...
  do
    ...
    do
      ...
      read -u 6
      {
        ...
        time ./Local-MIP -i $instance/$file --cutoff=172800 --PrintSol=1 --sampleUnsat=$a --bmsUnsatInfeas=$b --bmsUnsatFeas=$c --sampleSat=$d --bmsSat=$e --bmsFlip=$f --bmsRandom=$g --restartStep=$h
        echo >&6
