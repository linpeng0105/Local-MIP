...
result="/pub/netdisk1/linpeng/Local-MIP/result/highs1.5/log"
cutoff="10 60 300 3600"
ulimit -t 5000
...
do
  ...
  do
    ...
    do
      ...
      read -u 6
      {
        export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/pub/netdisk1/linpeng/paralle-local-ILP/highs/HiGHS/build/lib/
        cd /pub/netdisk1/linpeng/paralle-local-ILP/highs/HiGHS/build/bin
